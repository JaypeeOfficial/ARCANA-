...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20230727081642_Adjustmentsss")]
    partial class Adjustmentsss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductCategoryProductSubCategory", b =>
                {
                    ...
                    b.HasKey("ProductCategoryId", "ProductSubCategoryId")
                        .HasName("pk_product_category_product_sub_category");

                    b.HasIndex("ProductSubCategoryId")
                        .HasDatabaseName("ix_product_category_product_sub_category_product_sub_category_id");

                    b.ToTable("product_category_product_sub_category", (string)null);
                });
            ...
            modelBuilder.Entity("ProductCategoryProductSubCategory", b =>
                {
                    b.HasOne("RDF.Arcana.API.Domain.ProductCategory", null)
                        .WithMany()
                        .HasForeignKey("ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_category_product_sub_category_product_categories_pro");

                    b.HasOne("RDF.Arcana.API.Domain.ProductSubCategory", null)
                        .WithMany()
                        .HasForeignKey("ProductSubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_category_product_sub_category_product_sub_categories");
                });
